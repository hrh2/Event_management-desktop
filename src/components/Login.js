          ...
          <div className='bg-gray-800 flex flex-col justify-center'>
            <form className='max-w-[400px] w-full mx-auto rounded-lg p-8 px-8'>
                ...
                <div className='flex flex-col text-gray-400 py-2 mt-9'>
                    ...
                    <input className='mt-5 p-2 rounded-lg focus:border-blue-500 border-stone-200 bg-slate-600 text-center' type="text" placeholder='johndoe@example.com' />
                </div>
                <div className='flex flex-col text-gray-400 py-2'>
                    <label>Password</label>
                    <input className='mt-5 p-2 rounded-lg focus:border-blue-500 border-stone-200 bg-slate-600 text-center' type="password" placeholder='........'/>
                </div>
